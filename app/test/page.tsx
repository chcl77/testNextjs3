...
export default function TeamFind() {
    ...
    const [activeMenu, setActiveMenu] = useState<string>("find");
            ...
            <main style={{ maxWidth: "860px", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
                ...
                <div style={{ position: "relative", marginBottom: "10px" }}>
                    ...
                    <input
                        ...
                        onFocus={(e: React.FocusEvent<HTMLInputElement>) => (e.target.style.borderColor = "#10b981")}
                        onBlur={(e: React.FocusEvent<HTMLInputElement>) => (e.target.style.borderColor = "#6ee7b7")}
                    />
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    {filtered.length > 0 ? (
                        filtered.map((team: Team, i: number) => (
                            <div
                                key={team.id}
